...
from .clients import generate_json as _generate_json
from .clients import get_web_context as _get_web_context
...
from ..domain.onboarding_mode_hints import (
...
async def generate_foundation(messages: list[dict], state: dict, project_type: str = "startup") -> dict:
    ...
    foundation = raw.get("foundation", raw) if isinstance(raw, dict) else raw
